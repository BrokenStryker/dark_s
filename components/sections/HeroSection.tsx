        ...
        <div className="bg-card/95 backdrop-blur-sm p-8 rounded-lg border">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1 text-center lg:text-left">
              <p className="text-xl md:text-2xl text-foreground mb-4 font-light font-trajan">
              Hair that you'll love, no matter what.
              </p>
              <p className="text-lg text-muted-foreground mb-8 font-futura">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center">
                <Button size="lg" variant="outline" className="px-8 py-3 text-lg font-futura" onClick={() => document.getElementById('services')?.scrollIntoView({ behavior: 'smooth' })}>
                  View Services
                </Button>
              </div>
            </div>
