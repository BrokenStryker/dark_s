          ...
          <div className="order-2 lg:order-2 text-left">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <BodyText size="medium" muted>2019 Graduate From Dutchess BOCES Career Institute</BodyText>
              </div>

              <div className="flex items-start gap-3">
                <Briefcase className="w-5 h-5 text-foreground mt-1 flex-shrink-0" />
                <BodyText size="medium" muted>Six Years of Cosmotology, Licensed in NY, NJ, and AK </BodyText>
              </div>

              <div className="flex items-start gap-3">
                <Paintbrush className="w-5 h-5 text-foreground mt-1 flex-shrink-0" />
                <BodyText size="medium" muted>Lived In Blondes, Brunettes, Dimensional Shades, Layered Cuts, and Bouncy Blowouts</BodyText>
              </div>

              <div className="flex items-start gap-3">
                <TrendingUp className="w-5 h-5 text-foreground mt-1 flex-shrink-0" />
                <BodyText size="medium" muted>Why Me? Always studying trends to create the best look for you</BodyText>
              </div>

              <div className="flex items-start gap-3">
                <Heart className="w-5 h-5 text-foreground mt-1 flex-shrink-0" />
                <BodyText size="medium" muted>Gizmo Time (My Cat), Romance Novels, Rock Music, and Working Out</BodyText>
              </div>

              <div className="flex items-start gap-3">
                <House className="w-5 h-5 text-foreground mt-1 flex-shrink-0" />
                <BodyText size="medium" muted>Founder of Dark Serenity</BodyText>
              </div>
